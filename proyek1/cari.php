...
?>
<p><center><input type="button" value="Lihat Data" onClick="window.location.href='lihatdata.php'"> <input type="button" value="Input Data" onClick="window.location.href='pendaftaran.html'">
</center></p>